...
/**
 * Legacy chat page for when conversations table doesn't exist yet.
 * Uses the old queries API instead of conversations.
 */
export function LegacyChatPage() {
  ...
  const handleCitationClick = (citation: Citation) => {
    // Open PDF in the split-view panel
